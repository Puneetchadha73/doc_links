...
groq_api_ke="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"
...
def create_embeddings():
    ...
    if 'embeddings' not in st.session_state:
        st.session_state.embeddings = OpenAIEmbeddings(openai_api_key=st.secrets["OPENAI_API_KEY"])


st.markdown("### <ins>Content Chatbot</ins>", unsafe_allow_html=True)
